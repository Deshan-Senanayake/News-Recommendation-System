...
public class UserValidatorTest {
    ...
    public void testValidUserDetails() {
        UserValidator.validate("ValidUser", "user@example.com",
    ...
    public void testInvalidUsername() {
        try {
            UserValidator.validate("ab", "user@example.com",
                    "Password123", "Password123");
    ...
    public void testInvalidEmail_one() {
        try {
            UserValidator.validate("ValidUser", "userexample.com",
                    "Password123", "Password123");
    ...
    public void testInvalidEmail_two() {
        try {
            UserValidator.validate("ValidUser", "userexamplecom",
                    "Password123", "Password123");
